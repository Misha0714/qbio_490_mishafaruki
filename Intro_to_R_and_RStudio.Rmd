...
###### (2) Setting Up Your Environment
  ...
  When you first open a document, you want to make sure that your working directory is properly set. This allows you to both access files on your local machine,cl and to write files onto that machine.
...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/mishafaruki/Desktop/QBIO490/qbio_490_mishafaruki")) 
```
...
```{r Exercise 3.4}
## add code here!
name <- "Misha Faruki" #string
typeof(name)
age <- 19 #integer
typeof(age)
birthday <- "07/14/2004"  #string
typeof(birthday)
three_fav_colors <- c("blue", "green", "purple") #vector
...
mode_of_numbers
summary_of_numbers <- summary(list_of_numbers)
summary_of_numbers
...
if (7.5 %in% new_list) {
  print("A") #false so does not enter next if statement 
  if (!7.5 %in% new_list) {
    print ("B")  
  }
...
``` #Prediction: D E , why is F not printed? 
###### (6) Loops
...
# write code here
rownames(mtcars)
print(mtcars[7, 4]) #Duster360 
print(mtcars[16, 4]) #Lincoln Continental
print(mtcars[31, 4]) #Maserati Bora 
```
